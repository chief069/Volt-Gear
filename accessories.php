...
$sql = "SELECT productID, productname, price, ProductImage,catID,productdet FROM product WHERE catID = 4";
$result = $conn->query($sql);
...
<head>
    ...
    <title>VOLT GEAR - Gaming Accessories</title>
...
<body>
    ...
    <section class="category-banner">
        ...
        <p>Unleash your full potential with pro-grade gaming accessories built for speed, precision, and victory.</p>
    </section>
