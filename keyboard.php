...
$sql = "SELECT productID, productname, price, ProductImage,catID,productdet FROM product WHERE catID = 2";
$result = $conn->query($sql);
...
<head>
    ...
    <title>Gaming Keyboards - VOLT GEAR</title>
...
<body>
    ...
    <section class="category-banner">
        ...
        <p>Precision engineered mechanical keyboards designed for elite gamers. Experience faster response times, customizable RGB lighting, and premium build quality.</p>
    </section>
