...
$sql = "SELECT productID, productname, price, ProductImage,catID,productdet FROM product WHERE catID = 1";
$result = $conn->query($sql);
...
<head>
    ...
    <title>VOLT GEAR - Gaming Mouses</title>
...
<body>
    ...
    <section class="category-banner">
        <h2>Gaming Mouses</h2>
        <p>Suggests that with this mouse, gamers have no reason to miss their shots or moves.</p>
    </section>
